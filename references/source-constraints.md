...
- **GitHub Constraints:** Restrict API searches to repositories containing data identifiers in `README.md`. Force the scraper to look exclusively for tabular file extensions (`.csv`, `.xlsx`) in paths containing `/data/`, `/datasets/`, or `/raw/`. Do not download source code files.
